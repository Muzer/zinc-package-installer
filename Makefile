#############################################################################
# Makefile for building: zinc-package-installer
# Generated by qmake (2.01a) (Qt 4.5.2) on: Thu Sep 24 15:39:50 2009
# Project:  zinc-package-installer.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/lib/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile zinc-package-installer.pro
#############################################################################
...
DIST          = /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		...
		zinc-package-installer.pro
QMAKE_TARGET  = zinc-package-installer
DESTDIR       = 
...
Makefile: zinc-package-installer.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/features/qt_functions.prf \
		...
		/usr/lib/qt4/mkspecs/features/lex.prf \
		/usr/lib/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -spec /usr/lib/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile zinc-package-installer.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/zinc-package-installer1.0.0 || $(MKDIR) .tmp/zinc-package-installer1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/zinc-package-installer1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/zinc-package-installer1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/zinc-package-installer1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/zinc-package-installer1.0.0/ && (cd `dirname .tmp/zinc-package-installer1.0.0` && $(TAR) zinc-package-installer1.0.0.tar zinc-package-installer1.0.0 && $(COMPRESS) zinc-package-installer1.0.0.tar) && $(MOVE) `dirname .tmp/zinc-package-installer1.0.0`/zinc-package-installer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/zinc-package-installer1.0.0
